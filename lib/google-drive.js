...
/** Sube cualquier archivo a Drive, en <raíz de bendito-os>/Contenido/<subcarpeta>. Devuelve el link o null si Drive no está conectado. */
async function subirArchivoAContenido(nombreArchivo, buffer, subcarpeta, mimeType) {
...
async function subirPdfAContenido(nombreArchivo, buffer, subcarpeta) {
  return subirArchivoAContenido(nombreArchivo, buffer, subcarpeta, 'application/pdf');
}

module.exports = { subirPdfAContenido, subirArchivoAContenido };
