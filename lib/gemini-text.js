    ...
    'https://generativelanguage.googleapis.com/v1beta/models/' + MODEL + ':generateContent?key=' + encodeURIComponent(apiKey),
    {
      ...
      body: JSON.stringify({
        ...
        generationConfig: {
          ...
          // un límite ajustado el JSON se corta a mitad. (thinkingConfig no
          // se usa aquí: el modelo detrás del alias "gemini-flash-latest" lo
          // rechaza con 400 INVALID_ARGUMENT.)
